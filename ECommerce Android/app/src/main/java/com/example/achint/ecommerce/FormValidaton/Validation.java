package com.example.achint.ecommerce.FormValidaton;
...
public class Validation {
    ...
    private static final String PHONE_REGEX = "^[2-9]{2}[0-9]{8}$";
    ...
    private static final String PASSWORD_MSG = "range has to be 3-15 characters";
    ...
    public static boolean isPhoneNumber(EditText editText, boolean required) {
        return isValid(editText, PHONE_REGEX, PHONE_MSG, false);
    }
